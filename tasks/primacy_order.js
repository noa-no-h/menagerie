...
stimulus_array = condition[0] == "Factor-Included" ? bad_1_first : random
 ...
 var introspection_q_labels_mee1 = [`<strong>The fact that all the positive facts about the ${car1} and the negative facts about the ${car2} showed up towards the beginning of the list, made me think the ${car1} was <u>THE BETTER</u></strong> car`, "", "<strong>The order of the facts did not affect my response</strong>", "", `<strong>The fact that all the positive facts about the ${car1} and the negative facts about the ${car2} showed up towards the beginning of the list, made me think the ${car1} was <u>THE WORSE</u></strong> car`];
 var introspection_q_labels_mee2 = [`<strong>If all the positive facts about the ${car1} and the negative facts about the ${car2} showed up towards the beginning of the list, that would have made me think the ${car1} was <u>THE BETTER</u></strong> car`, "", "<strong>The order of the facts would not have affected my response</strong>", "", `<strong>If all the positive facts about the ${car1} and the negative facts about the ${car2} showed up towards the beginning of the list, that would have made me think the ${car1} was <u>THE WORSE</u></strong> car`];

...
<br><p>You will be asked to answer this question on a scale from definitely true to definitely false.</p>
    ...
    timeline: [
        {
            ...
            stimulus_height: 350,
            labels: [`<strong>1<br>Definitely True</strong>`, "2", "3", "4", "5", "6", "7", "8", `<strong>9<br>Definitely False</strong>`],
...
var introspection_q_labels_mee1 = [`<strong>When I saw a trivia statement a lot of times, that made me judge the statement as <u>LESS</u></strong> likely to be true`, "", "<strong>The number of times I saw a statement did not affect my response</strong>", "", `<strong>When I saw a trivia statement a lot of times, that made me judge the statement as <u>MORE</u></strong> likely to be true`];
var introspection_q_labels_mee2 = [`<strong>If I had seen a trivia statement a lot of times, that would have made me judge the statement as <u>LESS</u></strong> likely to be true`, "", "<strong>The number of times I saw a statement would not have affected my response</strong>", "", `<strong>If I had seen a trivia statement a lot of times, that would have made me judge the statement as <u>MORE</u></strong> likely to be true`];
    ...
    stimulus: function () {
        if (condition[0] == "Factor-Included") {
            return `During this exercise, you were shown a series of trivia statements and you were asked to assess whether each claim was true or false. 
                    ...
                    <p>Do you think <b>whether or not you had seen a statement before</b> affected  your assessment of whether it was true or false? If so, how?`
        } else {
            return `During this exercise, you were shown a series of trivia statements and you were asked to assess whether each claim was true or false. Some of these claims had been shown to you earlier in the experiment and some you just saw for the first time.
                    ...
                    Do you think <b>whether or not you had seen a statement before</b> would have  affected your assessment of whether it was true or false? If so, how?`
                        }
    },

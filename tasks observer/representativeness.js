...
from 0 to 100.<br><br>
The probability that Jack is one of the 30 engineers in the sample of 
100 is:<br><br> The Prolific user selected ` + observedChoice + `. Below, to demonstrate that you understand the Prolific user's choice, please move the slider to the option that they selected (regardless of your own beliefs). `;
...
questions: [{
    ...
    process was behind their decision about probability to give.</p>`,

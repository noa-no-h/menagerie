...
// Check if the table name is provided and sanitize the input.
/*if (isset($_POST['table'])) {
  $table = $_POST['table'];
  // Sanitization example: ensure the table name contains only alphanumeric characters and underscores
  if (!preg_match('/^[a-zA-Z0-9_]+$/', $table)) {
      die('{"success": false, "message": "Invalid table name"}');
  }
} else {
  die('{"success": false, "message": "No table specified"}');
}*/
